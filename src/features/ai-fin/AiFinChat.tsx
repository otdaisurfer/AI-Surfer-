...
const styles: Record<string, React.CSSProperties> = {
  launcherWrap: {
    ...
    justifyItems: 'end',
    gap: 12,
    maxWidth: 'min(300px, calc(100vw - 36px))',
  },
  launcherHint: {
    padding: '12px 16px',
  ...
  iconButton: { minWidth: 44, minHeight: 44, border: 0, background: 'transparent', color: 'white', cursor: 'pointer', display: 'grid', placeItems: 'center', padding: 7, borderRadius: 9 },
  ...
  field: { boxSizing: 'border-box', width: '100%', border: '1px solid rgba(255,255,255,.14)', borderRadius: 10, padding: '11px 12px', background: 'rgba(3,8,26,.72)', color: 'white', outline: 'none', fontSize: 16 },
  ...
  composerInput: { flex: 1, minWidth: 0, border: '1px solid rgba(255,255,255,.15)', borderRadius: 12, padding: '11px 12px', background: 'rgba(255,255,255,.06)', color: 'white', outline: 'none', fontSize: 16 },
  sendButton: { width: 44, height: 44, flex: '0 0 44px', display: 'grid', placeItems: 'center', border: 0, borderRadius: 12, background: 'linear-gradient(135deg,#ff4fb8,#12d9ff)', color: 'white', cursor: 'pointer' },
